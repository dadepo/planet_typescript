...
sudo docker pull ghcr.io/dadepo/planet-typescript:latest && sudo docker run --rm -d -v /usr/local/planetts/data:/usr/local/planetts/data -p $NEW_PORT:4300 ghcr.io/dadepo/planet-typescript:latest
