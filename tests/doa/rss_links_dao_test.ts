    ...
    async fn(){
        ...
        switch(result.kind) {
            ...
            case("success"):{
                ...
                assertEquals(link1[0], "https://www.example.com/rss.xml");
                assertEquals(link2[0], "https://www.example1.com/rss.xml");
                assertEquals(link3[0], "https://www.example2.com/rss.xml");
                break
            }
